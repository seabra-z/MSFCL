...
#
    ...
    parser.add_argument('--dimensions_sim', type=int, default=1565,
                        help='dimensions of sim_feature. Default is 1565.')
...
#
    ...
    parser.add_argument('--zhongzi', default=3,
                        help='Number of zhongzi.')
    parser.add_argument('--eta', type=float, default=0.1)
    parser.add_argument('--alpha', type=float, default=0.5)
    parser.add_argument('--tau', type=float, default=0.1)
    parser.add_argument('--dataset',  type=str, default='ddinter')
#
